...
$sitename = "南湖监狱信发系统";
$link = array(
    'qqun'  => "tencent://message/?uin=389049320&Site=qq&Menu=yes",
    'gitee' => '1',
    'home'  => '2',
    'forum' => '3',
    'doc'   => '#',
...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $mysqlDatabase = isset($_POST['mysqlDatabase']) ? $_POST['mysqlDatabase'] : 'LingChen';
    $mysqlPrefix = isset($_POST['mysqlPrefix']) ? $_POST['mysqlPrefix'] : 'nh_';
    ...
    try {
        ...
        $sql = str_replace("`nh_", "`{$mysqlPrefix}", $sql);
...
<div class="container">
    ...
    <div>
        ...
        <p>若你在安装中遇到麻烦可致电:18668418885 或点击  <a
                    href="<?php echo $link['qqun']; ?>">QQ联系</a></p>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="mysqlDatabase" value="nanhu_info" required="">
                </div>
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="mysqlPrefix" value="nh_">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-field">
                    ...
                    <input name="adminEmail" value="nk11@qq.com" required="">
                </div>
